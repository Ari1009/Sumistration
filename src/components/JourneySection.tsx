...
import { Palette, Tablet, Coffee, Sparkles, Pen, Monitor, Heart } from 'lucide-react'
...
const JourneySection: React.FC = () => {
  const journeySteps = [
    ...
    {
      title: "The Growth", 
      description: "Discovered digital art!",
      icon: Tablet,
    ...
    {
      title: "The Present",
      description: "Now creating manga illustrations!",
      icon: Sparkles,
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="font-manga font-bold text-5xl text-manga-text mb-6">
              My Journey
            </h2>
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10 text-center">
                    <motion.div
                      className="bg-white w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6 manga-panel"
                    ...
                    <motion.div
                      className="speech-bubble inline-block bg-white/90"
                      initial={{ scale: 0 }}
                      whileInView={{ scale: 1 }}
          ...
          {/* Tools Section */}
          <motion.div
            className="manga-panel bg-white/95 backdrop-blur-sm rounded-2xl p-8"
            initial={{ y: 100, opacity: 0 }}
            whileInView={{ y: 0, opacity: 1 }}
            transition={{ duration: 0.8, delay: 0.7 }}
            viewport={{ once: true }}
          >
            <h3 className="font-manga font-bold text-3xl text-manga-text text-center mb-8">
              My Creative Arsenal
            </h3>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {tools.map((tool, index) => {
                ...
                return (
                  ...
                  >
                    <motion.div 
                      className={`${tool.color} w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-3 manga-panel group-hover:shadow-lg`}
                      whileHover={{ rotate: 360 }}
                      transition={{ duration: 0.6 }}
                    >
                      <Icon className="text-white" size={24} />
                    </motion.div>
                    <p className="font-zen font-medium text-manga-text group-hover:text-manga-red transition-colors">
                      {tool.name}
                    </p>
                  </motion.div>
                )
